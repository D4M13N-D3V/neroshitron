...
function PageComponent() {
    ...
    return (
        ...
        <div className="w-full lg:w-1/3 rounded-md bg-primary p-12 m-1 mt-32 shadow-lg">
            ...
            <div className="w-full flex">
                <input type="text" className="mb-8 shadow-lg mr-2 rounded-md bg-secondary p-2 w-full text-white" placeholder="Search all tags by name" />
            </div>
                    ...
                    {tags.map((item:any) => (
                        <tr key={item.name} className="animate-in">
                            ...
                            <td className="px-4 py-2">
                                <button  className="bg-error shadow-lg hover:bg-error-light text-white font-bold py-2 px-4 rounded float-right">
                ...
                <tbody>
                    ...
                    {galleries.map((item: { name: string, imageCount: number, tier: string }) => (
                        <tr key={item.name} className="animate-in">
                            ...
                            <td className="px-4 py-2">
                                <a href="/gallery/admin/view" className="bg-secondary shadow-lg hover:bg-secondary-light text-white font-bold py-2 px-4 rounded float-right">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
